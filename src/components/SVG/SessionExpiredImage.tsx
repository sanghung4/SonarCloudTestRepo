...
const SessionExpiredImage: React.FC<SVGProps> = ({ style, size, ...rest }) => {
  return (
    <View
      testID={SVG_TEST_IDS.SESSION_EXPIRED}
      style={StyleSheet.flatten([
        style,
        { width: size, aspectRatio: 430.91406 / 559.70956 },
      ])}
      {...rest}
    >
      <SVG
...
SessionExpiredImage.defaultProps = {
  size: 73,
};
