...
public class PickingController {
    ...
    @PutMapping("tasks")
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody WarehousePickTaskList assignPickingTasks(@RequestBody WarehousePickTaskList list)
        throws EclipseTokenException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody ProductSerialNumbersResponseDTO getSerialNumbers(@PathVariable String warehouseId)
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody WarehouseCloseTask closeTask(@RequestBody WarehouseCloseTask request)
        throws EclipseTokenException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody WarehouseToteTask updateToteTask(@RequestBody WarehouseToteTask request)
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody WarehouseTotePackages updateTotePackages(@RequestBody WarehouseTotePackages request)
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody SplitQuantityResponseDTO splitQuantity(@RequestBody SplitQuantityRequestDTO request)
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody CloseOrderResponseDTO closeOrder(@RequestBody CloseOrderRequestDTO request)
    ...
    @GetMapping("/shipping")
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody KourierShippingDetailsResponseDTO getShippingDetails(@RequestParam String invoiceNumber)
        throws EclipseTokenException {
        return kourierService.getShippingDetails(invoiceNumber);
    }

    @GetMapping("/validateBranch/{branchId}")
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody BranchValidationDTO validateBranch(@PathVariable String branchId)
        throws InvalidBranchException, EclipseTokenException {
        if (StringUtil.hasNullorEmptyValue(branchId)) {
            throw new InvalidBranchException();
        }
        return eclipseService.validateBranch(branchId);
    }
}
