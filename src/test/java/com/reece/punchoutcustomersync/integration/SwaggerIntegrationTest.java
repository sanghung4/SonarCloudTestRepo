...
public class SwaggerIntegrationTest extends BaseIntegrationTest {
    ...
    private String apiDocsUrlPath;

    @Test
    public void validSwaggerDocumentation() throws Exception {
        MvcResult rs = mockMvc.perform(MockMvcRequestBuilders.get(apiDocsUrlPath)
                        .header("Origin", "*").header("X-Auth-Token", apiKey)
        ...
        ArrayList<String> restControllerNames = new ArrayList<>();
